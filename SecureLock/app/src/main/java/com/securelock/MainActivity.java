...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadSavedData() {
        ...
        if (editIndex >= 0) {
            ...
            // Load times
            int savedStartHour = prefs.getInt(prefix + "start_hour", 9);
            int savedStartMinute = prefs.getInt(prefix + "start_minute", 0);
            int savedEndHour = prefs.getInt(prefix + "end_hour", 17);
            int savedEndMinute = prefs.getInt(prefix + "end_minute", 0);
            
            startHour = savedStartHour;
            startMinute = savedStartMinute;
            endHour = savedEndHour;
            endMinute = savedEndMinute;
